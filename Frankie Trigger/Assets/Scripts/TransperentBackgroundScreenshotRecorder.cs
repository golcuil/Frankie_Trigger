...
public class TransparentBackgroundScreenshotRecorder : MonoBehaviour
{
    ...
    void CacheAndInitialiseFields()
    {
        ...
        textureBlack = new Texture2D(screenWidth, screenHeight, TextureFormat.ARGB32, false);
        textureWhite = new Texture2D(screenWidth, screenHeight, TextureFormat.ARGB32, false);
